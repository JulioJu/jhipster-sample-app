...
export class OperationPopupService {
  ...
  constructor(private modalService: NgbModal, private router: Router, private operationService: OperationService) {
    ...
    return new Promise<NgbModalRef>((resolve, reject) => {
      ...
      if (id) {
        this.operationService.find(id).subscribe((operationResponse: HttpResponse<IOperation>) => {
          const operation: IOperation = operationResponse.body;
  ...
  operationModalRef(component: Component, operation: IOperation): NgbModalRef {
